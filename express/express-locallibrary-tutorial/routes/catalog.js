...
router.get('/',book_controller.create_get)

// POST request for creating a Book.
router.post('/',book_controller.create_post)

// GET request to delete a Book.
router.get('/book/:id/delete',book_controller.delete_get)

// POST request to delete a Book.
router.post('/book/:id/delete',book_controller.delete_post)

// GET request to update a Book.
router.get('/book/:id/update',book_controller.update_get)
